...
\usepackage[hypcap=true]{subcaption} % reemplaza a subfig y subfloats
% todo el titulo en negrita y subfiguras se referencian entre
% parentesis, ej Figura 1(a)
...
%  para cambiar interlineado
% en diferentes partes del texto
% \setstretch{1.3}
\usepackage{setspace}
% Salto de parrafo, genera mas espacio en el indice tambien
...
%\usepackage{titlesec}
%% Formato de titulos oficial
%\titleformat{\chapter}[hang] % Customise the \section command
%%{\Huge\scshape\raggedright}%
%%{\LARGE\sffamily\bfseries\raggedright}%
%{\LARGE\bfseries\raggedright}%
%{\chaptertitlename~\thechapter.}{1em} % Can be used to give a prefix to all sections, like 'Section ...'
%{} % Can be used to insert code before the heading
%[\chaprule] % Inserts a horizontal line after the heading 
%\titlespacing*{\chapter}{0pt}{-50pt}{40pt}

%\titleformat{\chapter}[hang]{\color{tableau10_1}\Huge\bfseries}{\thechapter\hsp\textcolor{gray75}{|}\hsp}{0pt}{\color{tableau10_1}\Huge\bfseries}
%\titleformat*{\section}{\color{tableau10_1}}

\fancyhf{}
\fancyhead[l]{\footnotesize \textsc{Universidad de Concepción}\\
\textsc{Facultad de Ingeniería}\\
\textsc{Departamento de Ingeniería Eléctrica}}
\fancyhead[r]{\includegraphics[scale=0.12]{logoudec}}
\fancyfoot[r]{\thepage}
\fancyfoot[c]{}
%\pagestyle{fancy}
...
%\SetWatermarkAngle{0}
%\SetWatermarkText{\transparent{0.1}{\includegraphics{logoudec}}}
...
% numerar ecuaciones como chapter.numero
...
\newcommand\@ComisionA{}
\newcommand\@ComisionB{}
\newcommand{\ComisionA}[1]{\renewcommand\@ComisionA{#1\\}}
\newcommand{\ComisionB}[1]{\renewcommand\@ComisionB{#1\\}}
\makeatother
...
%    pdfmenubar=true,        % show Acrobat’s menu?
    ...
    pdftitle={Proyecto de Memoria de Título: \Title},    % title
...
%    linkcolor=tableau10_10,          % color of internal links (change box color with linkbordercolor)
