...
\usepackage[caption = false]{subfig} % no usar
...
% genera problemas cuando las ref tienen url
...
\newcommand\@ComisionA{}
\newcommand\@ComisionB{}
\newcommand{\ComisionA}[1]{\renewcommand\@ComisionA{#1\par}}
\newcommand{\ComisionB}[1]{\renewcommand\@ComisionB{#1\par}}
\makeatother
